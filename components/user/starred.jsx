...
export default forwardRef(({alertPopup, alert, setAlert, setAuth, auth, listPopup}, ref) => {
    ...
    useImperativeHandle(ref, () => ({
        show() {
            setLists(auth.lists.filter((list) => !list.archive && list.star))
            setFadeOut(false)
            setVisibility(true)
        }
    }))
        ...
        <>
            ...
            <div
                ...
                <div className={starredStyles.container_wrapper}>
                    ...
                    <h1 className={starredStyles.title}>Starred Lists</h1>
                    <h3 className={starredStyles.description}>You can view and manage your starred lists here.</h3>
                    <div className={starredStyles.lists}>
                        ...
                        }) : <h3 className={starredStyles.empty_text}>No starred lists found.</h3>}
                    </div>
                </div>
            </div>
        </>
